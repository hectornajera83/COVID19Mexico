...
Model.B<-brm(death ~ 1 + f_gap + f_gap2  + sector_3 + sector_4 + sector_6 + sector_8 + sector_9 + sector_12 + sector_11  + edad + edad2 + habla_lengua_indig_1 + obesidad_2 + cardiovascular_2 + renal_cronica_2 + tabaquismo_2 + hipertension_2 + inmusupr_2 + asma_2 + diabetes_2 + embarazo_2 + sexo_1 + lastWeek_1 + lastWeek_2 + lastWeek_3, data = D1, prior = c(set_prior("normal(0,10)", class="b"),
 ...
 family = "bernoulli", chains=6, cores=6, iter = 1000, control = list(max_treedepth = 12))
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
sexo.m<-ggpredict(Model.B, terms = c("sexo_1"), condition = c(tabaquismo_2 = .6,
                                                               diabetes_2= .6,
                                                               obesidad_2=.6,
                                                               cardiovascular_2 = .6,
...
sexo.r<-ggpredict(Model.B, terms = c("sexo_1"), ci.lvl = 0.90, condition = c(tabaquismo_2 = .1,
                                                               diabetes_2= .1,
                                                               obesidad_2= .1,
                                                               cardiovascular_2 = .1,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
...
diabetes.r<-ggpredict(Model.B, terms = c("diabetes_2"), ci.lvl = 0.90, condition = c(tabaquismo_2 = .1,
                                                               obesidad_2= .1,
                                                               cardiovascular_2 = .1,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
cardiovascular.m<-ggpredict(Model.B, terms = c("cardiovascular_2"), condition = c(tabaquismo_2 = .6,
                                                               diabetes_2= .6,
                                                               hipertension_2 = .6,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
...
cardiovascular.r<-ggpredict(Model.B, terms = c("cardiovascular_2"), ci.lvl = 0.90, condition = c(tabaquismo_2 = .1,
                                                               obesidad_2= .1,
                                                               hipertension_2 = .1,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
renal.m<-ggpredict(Model.B, terms = c("renal_cronica_2"), condition = c(tabaquismo_2 = .6,
                                                               diabetes_2= .6,
                                                               cardiovascular_2 = .6,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
...
renal.r<-ggpredict(Model.B, terms = c("renal_cronica_2"), ci.lvl = 0.90, condition = c(tabaquismo_2 = .1,
                                                               obesidad_2= .1,
                                                               cardiovascular_2 = .1,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
tab.m<-ggpredict(Model.B, terms = c("tabaquismo_2"), condition = c(renal_cronica_2 = .6,
                                                               diabetes_2= .6,
                                                               cardiovascular_2 = .6,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
...
tab.r<-ggpredict(Model.B, terms = c("tabaquismo_2"), ci.lvl = 0.90, condition = c(renal_cronica_2 = .1,
                                                               obesidad_2= .1,
                                                               cardiovascular_2 = .1,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
...
tab.m$riesgo<-"Medio"
tab.r$riesgo<-"Alto"
tab<-rbind(tab.m,tab.r)

tab$x<-ifelse(tab$x==1,"Sin tabaquismo","Con tabaquismo")

ggplot(tab, aes(x = x, y = predicted*100, colour=riesgo, group=riesgo)) +
  geom_point(position=position_dodge(width=.3)) +
  geom_pointrange(aes(ymin = conf.low*100, ymax = conf.high*100), fatten = 8, position=position_dodge(width=.3)) + labs(x="Tabaquismo", y="Probabilidad fallecimiento (%). CI 95%", color = "Riesgo factores de salud") + 
   ylim(c(4,35)) + 
 theme_classic() + scale_color_manual(values=c("#47B374", "#CE803B"))
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
dia.obs<-ggpredict(Model.B, terms = c("diabetes_2", "obesidad_2"), condition = c(tabaquismo_2 = .6,
                                                               cardiovascular_2 = .6,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
                                                               hipertension_2 = .6,
...
### Interacción: Diabetes e hipertensión

```{r echo=FALSE, warning=FALSE, message=FALSE}
dia.hip<-ggpredict(Model.B, terms = c("diabetes_2", "hipertension_2"), condition = c(tabaquismo_2 = .6,
                                                               cardiovascular_2 = .6,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
                                                               obesidad_2 = .6,
...
dia.hip$diabetes<-c("Con diabetes","Sin diabetes", "Con diabetes","Sin diabetes")
dia.hip$hipertension<-c("Con hipertensión","Con hipertensión", "Sin hipertensión","Sin hipertensión")

ggplot(dia.hip, aes(x = hipertension, y = predicted*100, colour=diabetes, group=diabetes)) +
  geom_point(position=position_dodge(width=.3)) +
  geom_pointrange(aes(ymin = conf.low*100, ymax = conf.high*100), fatten = 8, position=position_dodge(width=.3)) + labs(x="Interacción diabetes e hipertensión", y="Probabilidad fallecimiento (%). CI 95%. Riesgo medio", color = "Riesgo factores de salud") + 
   ylim(c(0,25)) + 
 theme_classic() + scale_color_manual(values=c("#FF0000", "#004D54")) +  theme(legend.position = "bottom")
```

### Interacción obesidad e hipertensión

```{r echo=FALSE, warning=FALSE, message=FALSE}
obs.hip<-ggpredict(Model.B, terms = c("obesidad_2", "hipertension_2"), condition = c(tabaquismo_2 = .6,
                                                               cardiovascular_2 = .6,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
                                                               obesidad_2 = .6,
...
obs.hip$obesidad<-c("Con obesidad","Sin obesidad", "Con obesidad","Sin obesidad")
obs.hip$hipertension<-c("Con hipertensión","Con hipertensión", "Sin hipertensión","Sin hipertensión")

ggplot(obs.hip, aes(x = hipertension, y = predicted*100, colour=obesidad, group=obesidad)) +
  geom_point(position=position_dodge(width=.3)) +
  geom_pointrange(aes(ymin = conf.low*100, ymax = conf.high*100), fatten = 8, position=position_dodge(width=.3)) + labs(x="Interacción obesidad e hipertensión", y="Probabilidad fallecimiento (%). CI 95%. Riesgo medio", color = "Riesgo factores de salud") + 
   ylim(c(0,25)) + 
 theme_classic() + scale_color_manual(values=c("#290A27", "#6DA4A5")) +  theme(legend.position = "bottom")
```
...
### Interacción edad e diabetes

```{r echo=FALSE, warning=FALSE, message=FALSE}
edad.dib<-ggpredict(Model.B, terms = c("edad", "diabetes_2"), condition = c(tabaquismo_2 = .6,
                                                               cardiovascular_2 = .8,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
                                                               renal_cronica_2 = .8,
...
edad.dib$Diabetes<-ifelse(edad.dib$group==1,"Con diabetes","Sin diabetes")


ggplot(edad.dib, aes(x = x, y = predicted*100, colour=Diabetes, group=Diabetes)) +
  geom_line(position=position_dodge(width=.3)) +
  geom_ribbon(aes(ymin = conf.low*100, ymax = conf.high*100, fill=Diabetes), alpha=.8) + labs(x="Edad", y="Probabilidad fallecimiento (%). CI 95%. Riesgo medio") + 
   ylim(c(0,100)) + xlim(c(0,100)) +
 theme_classic() + scale_fill_manual(values=c("#57BDF7", "#FF5C5C")) +  scale_color_manual(values=c("#57BDF7", "#FF5C5C")) +  theme(legend.position = "bottom")
```

### Interacción edad y obesidad

```{r echo=FALSE, warning=FALSE, message=FALSE}
edad.obs<-ggpredict(Model.B, terms = c("edad", "obesidad_2"), condition = c(tabaquismo_2 = .6,
                                                               cardiovascular_2 = .6,
                                                               habla_lengua_indig_1 = mean(D1$habla_lengua_indig_1),
                                                               embarazo_2 = mean(D1$embarazo_2),
                                                               renal_cronica_2 = .6,
...
edad.obs$Obesidad<-ifelse(edad.obs$group==1,"Con obesidad","Sin obesidad")


ggplot(edad.obs, aes(x = x, y = predicted*100, colour=Obesidad, group=Obesidad)) +
  geom_line(position=position_dodge(width=.3)) +
  geom_ribbon(aes(ymin = conf.low*100, ymax = conf.high*100, fill=Obesidad), alpha=.8) + labs(x="Edad", y="Probabilidad fallecimiento (%). CI 95%. Riesgo medio") + 
   ylim(c(0,100)) + xlim(c(0,100)) +
 theme_classic() + scale_fill_manual(values=c("#835B95", "#47B374")) +  scale_color_manual(values=c("#835B95", "#47B374")) +  theme(legend.position = "bottom")
```
