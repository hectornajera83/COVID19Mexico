...
a$Efecto<-ifelse(a$`2.5%`>1,"Incrementa riesgo",ifelse(a$`97.5%`<1,"Reducción en riesgo","Sin evidencia de su efecto"))
...
kable(a) %>% kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"),  full_width = F, font_size = 14) %>%
  row_spec(c(2,3,4,7,9,10), bold = T, color = "white", background = "#F62217") %>%
