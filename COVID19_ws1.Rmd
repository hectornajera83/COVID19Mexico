...
D1[,51:92]<-lapply(D1[,51:92], function(x) ifelse(x==0,.000000001,1))
...
```{r echo=FALSE}
ggplot(intu) + geom_point(aes(reorder(Intubado,Freq), Freq), size=7, colour="#0099cc") + theme_classic() + labs(y="% de fallecimientos dentro del grupo", x="Intubado") + ylim(c(0,70))
```
...
myBrks <- c(100,1000,5000,10000,20000,30000,50000)
labels <- c()
