...
Esta sección muestra la (<a href="https://hectornajera83.github.io/COVID19Mexico/Notas.html"> prevalencia ajustada</a>) de muertes según distintas condiciones demográficas y de salud. A diferencia de la  (<a href="https://hectornajera83.github.io/COVID19Mexico/COVID19_ws2.html"> prevalencia cruda</a>), se trata de probabilidades que permiten hacer conclusiones más robustas sobre los factores de riesgo de muerte por COVID-19. Se recomienda leer la *Nota: Prevalencia ajustada*. 
...
obesidad$x<-ifelse(sexo$x==1,"Mujer","Hombre")
