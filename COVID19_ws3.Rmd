...
### Descriptivo tiempo atención

```{r message=FALSE, warning=FALSE}
library(gridExtra)
ggplot(D1, aes(f_gap)) + geom_histogram(bins=25, color="#457D7E", fill="#307D7E")   + theme_classic() + labs(x="Brecha inicio de síntomas - atención", y="Casos diganosticados") + xlim(c(0,25))
```
