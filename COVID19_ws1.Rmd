...
```{r echo=FALSE}
ggplot(sector) + geom_point(aes(reorder(Institucion,Freq), Freq), size=4) + theme_classic() + labs(y="% de muertes dentro del grupo", x="Institución") +  theme(axis.text.x = element_text(angle = 90, hjust = 1), legend.position="bottom")
```
